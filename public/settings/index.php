...
$form = [
    ...
    'password_policy_text' => $stored['password_policy_text'] ?? ((string) app_config('password_policy_text', 'Use at least 12 characters. Consider a strong passphrase or password manager generated password.')),
];
...
if (submitted('POST')) {
    ...
    if ($errors === []) {
        ...
        audit_log(
            ...
            [
                'updated_keys' => ['app_name', 'default_timezone', 'session_timeout_minutes', 'password_policy_text'],
            ]
        );
        ...
        <section class="card section-card">
            <div class="page-actions">
                <div>
                    ...
                    <p>Store a small set of global application settings without disrupting existing functionality.</p>
                </div>
            </div>
            ...
            <form method="post" class="form-stack">
                ...
                <div class="form-section">
                    ...
                    <p>This controls how long an idle session can remain active before the user is redirected to the session expired page.</p>
                </div>
